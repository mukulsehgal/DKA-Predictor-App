...
# Features (include pH now)
features = ['PH', 'HGB_ALC_RESULT', 'PO2', 'PCO2', 'BASE_EXCESS', 'FIO2_VENOUS', 'O2_SAT_CALC_VENOUS',
...
# Save Model
joblib.dump(model, 'DKA_WBC_Predictor_With_pH.pkl')
print("Model trained and saved as 'DKA_WBC_Predictor_With_pH.pkl'")
